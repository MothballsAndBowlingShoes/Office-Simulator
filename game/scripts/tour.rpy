...
# MARK: Lobby Tour
    ...
    j "we'll have to ask you to refrain from harrassing the guests, whether that method be via cans of Bush's Baked Beans or by Hijacking Sheryl's intercom to play Despacito"
...
# MARK: Hallway Tour
    ...
    j "There's not much here outside of the the Offices, which is where you can find me if you ever need to. No guarantees that i'll be of any help though!"
