...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("{u}S{/u}kip") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("{u}A{/u}uto") action Preference("auto-forward", "toggle")
            textbutton _("{u}S{/u}ave") action ShowMenu('save')
